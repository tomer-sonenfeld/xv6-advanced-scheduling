...
00000000000000b2 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      d2:	3c270713          	addi	a4,a4,962 # 1490 <malloc+0x202>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     990:	b1c70713          	addi	a4,a4,-1252 # 14a8 <malloc+0x21a>
...
0000000000000a90 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     aa8:	9d448493          	addi	s1,s1,-1580 # 1478 <malloc+0x1ea>
     aac:	4589                	li	a1,2
     aae:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    printf("%s\n",msg);
     ...
     ada:	8b298993          	addi	s3,s3,-1870 # 1388 <malloc+0xfa>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     aee:	996b0b13          	addi	s6,s6,-1642 # 1480 <malloc+0x1f2>
    ...
    printf("%s\n",msg);
     ...
     b16:	6be080e7          	jalr	1726(ra) # 11d0 <printf>
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b78:	62e080e7          	jalr	1582(ra) # 11a2 <fprintf>
      continue;
  ...
  exit(0,"");
     ...
     b9a:	7fa58593          	addi	a1,a1,2042 # 1390 <malloc+0x102>
     b9e:	4501                	li	a0,0
...
_main()
{
  ...
  exit(0,"");
     ...
     bbc:	7d858593          	addi	a1,a1,2008 # 1390 <malloc+0x102>
     bc0:	4501                	li	a0,0
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f0e:	f4e080e7          	jalr	-178(ra) # e58 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f40:	58c50513          	addi	a0,a0,1420 # 14c8 <digits>
     f44:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    100c:	4c0b8b93          	addi	s7,s7,1216 # 14c8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    114c:	37890913          	addi	s2,s2,888 # 14c0 <malloc+0x232>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1366:	b5e080e7          	jalr	-1186(ra) # ec0 <sbrk>
  if(p == (char*)-1)

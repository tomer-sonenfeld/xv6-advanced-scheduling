...
user/_set_ps:     file format elf64-littleriscv
...
int main(int argc , char* argv[]){
   ...
   c:	378080e7          	jalr	888(ra) # 380 <memsize>
  10:	85aa                	mv	a1,a0
  12:	00000517          	auipc	a0,0x0
  16:	7fe50513          	addi	a0,a0,2046 # 810 <malloc+0xea>
  1a:	00000097          	auipc	ra,0x0
  1e:	64e080e7          	jalr	1614(ra) # 668 <printf>
    set_ps_priority(10);
  22:	4529                	li	a0,10
  24:	00000097          	auipc	ra,0x0
  28:	364080e7          	jalr	868(ra) # 388 <set_ps_priority>
    printf("%d\n" , memsize());   
  2c:	00000097          	auipc	ra,0x0
  30:	354080e7          	jalr	852(ra) # 380 <memsize>
  34:	85aa                	mv	a1,a0
  36:	00000517          	auipc	a0,0x0
  3a:	7da50513          	addi	a0,a0,2010 # 810 <malloc+0xea>
  3e:	00000097          	auipc	ra,0x0
  42:	62a080e7          	jalr	1578(ra) # 668 <printf>
...
_main()
{
  ...
  64:	7b858593          	addi	a1,a1,1976 # 818 <malloc+0xf2>
  68:	4501                	li	a0,0
...
0000000000000388 <set_ps_priority>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d8:	45450513          	addi	a0,a0,1108 # 828 <digits>
 3dc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a4:	388b8b93          	addi	s7,s7,904 # 828 <digits>
 ...
 5e4:	24090913          	addi	s2,s2,576 # 820 <malloc+0xfa>
        while(*s != 0){

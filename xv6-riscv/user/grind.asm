...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	45650513          	addi	a0,a0,1110 # 14f0 <malloc+0xf0>
      a2:	00001097          	auipc	ra,0x1
      a6:	f88080e7          	jalr	-120(ra) # 102a <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	44650513          	addi	a0,a0,1094 # 14f0 <malloc+0xf0>
      b2:	00001097          	auipc	ra,0x1
      b6:	f80080e7          	jalr	-128(ra) # 1032 <chdir>
      ba:	c115                	beqz	a0,de <go+0x66>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	43c50513          	addi	a0,a0,1084 # 14f8 <malloc+0xf8>
      c4:	00001097          	auipc	ra,0x1
      c8:	27e080e7          	jalr	638(ra) # 1342 <printf>
    exit(1,"");
      cc:	00001597          	auipc	a1,0x1
      d0:	5bc58593          	addi	a1,a1,1468 # 1688 <malloc+0x288>
      d4:	4505                	li	a0,1
  ...
  chdir("/");
      ...
      e2:	43a50513          	addi	a0,a0,1082 # 1518 <malloc+0x118>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      f2:	43a98993          	addi	s3,s3,1082 # 1528 <malloc+0x128>
      f6:	c489                	beqz	s1,100 <go+0x88>
      f8:	00001997          	auipc	s3,0x1
      fc:	42898993          	addi	s3,s3,1064 # 1520 <malloc+0x120>
    iters++;
     100:	4485                	li	s1,1
  int fd = -1;
     102:	597d                	li	s2,-1
     ...
     116:	41e50513          	addi	a0,a0,1054 # 1530 <malloc+0x130>
    ...
    if(what == 1){
     ...
     2ae:	4fe58593          	addi	a1,a1,1278 # 17a8 <malloc+0x3a8>
     ...
     2d2:	4e250513          	addi	a0,a0,1250 # 17b0 <malloc+0x3b0>
     2d6:	00001097          	auipc	ra,0x1
     2da:	06c080e7          	jalr	108(ra) # 1342 <printf>
        exit(1,"");
     2de:	00001597          	auipc	a1,0x1
     2e2:	3aa58593          	addi	a1,a1,938 # 1688 <malloc+0x288>
     2e6:	4505                	li	a0,1
     ...
     2f8:	24c50513          	addi	a0,a0,588 # 1540 <malloc+0x140>
     ...
     388:	1dc50513          	addi	a0,a0,476 # 1560 <malloc+0x160>
     ...
     3aa:	1ca50513          	addi	a0,a0,458 # 1570 <malloc+0x170>
     ...
     4ce:	1be58593          	addi	a1,a1,446 # 1688 <malloc+0x288>
     4d2:	00001097          	auipc	ra,0x1
     4d6:	af0080e7          	jalr	-1296(ra) # fc2 <exit>
        printf("grind: fork failed\n");
     4da:	00001517          	auipc	a0,0x1
     4de:	11650513          	addi	a0,a0,278 # 15f0 <malloc+0x1f0>
     4e2:	00001097          	auipc	ra,0x1
     4e6:	e60080e7          	jalr	-416(ra) # 1342 <printf>
        exit(1,"");
     4ea:	00001597          	auipc	a1,0x1
     4ee:	19e58593          	addi	a1,a1,414 # 1688 <malloc+0x288>
     4f2:	4505                	li	a0,1
     ...
     52c:	16058593          	addi	a1,a1,352 # 1688 <malloc+0x288>
     530:	4501                	li	a0,0
     532:	00001097          	auipc	ra,0x1
     536:	a90080e7          	jalr	-1392(ra) # fc2 <exit>
        printf("grind: fork failed\n");
     53a:	00001517          	auipc	a0,0x1
     53e:	0b650513          	addi	a0,a0,182 # 15f0 <malloc+0x1f0>
     542:	00001097          	auipc	ra,0x1
     546:	e00080e7          	jalr	-512(ra) # 1342 <printf>
        exit(1,"");
     54a:	00001597          	auipc	a1,0x1
     54e:	13e58593          	addi	a1,a1,318 # 1688 <malloc+0x288>
     552:	4505                	li	a0,1
     554:	00001097          	auipc	ra,0x1
     558:	a6e080e7          	jalr	-1426(ra) # fc2 <exit>
      sbrk(6011);
     55c:	6505                	lui	a0,0x1
     55e:	77b50513          	addi	a0,a0,1915 # 177b <malloc+0x37b>
     ...
     5a6:	06650513          	addi	a0,a0,102 # 1608 <malloc+0x208>
     ...
     5ec:	0a058593          	addi	a1,a1,160 # 1688 <malloc+0x288>
     5f0:	4501                	li	a0,0
     5f2:	00001097          	auipc	ra,0x1
     5f6:	9d0080e7          	jalr	-1584(ra) # fc2 <exit>
        printf("grind: fork failed\n");
     5fa:	00001517          	auipc	a0,0x1
     5fe:	ff650513          	addi	a0,a0,-10 # 15f0 <malloc+0x1f0>
     602:	00001097          	auipc	ra,0x1
     606:	d40080e7          	jalr	-704(ra) # 1342 <printf>
        exit(1,"");
     60a:	00001597          	auipc	a1,0x1
     60e:	07e58593          	addi	a1,a1,126 # 1688 <malloc+0x288>
     612:	4505                	li	a0,1
     614:	00001097          	auipc	ra,0x1
     618:	9ae080e7          	jalr	-1618(ra) # fc2 <exit>
        printf("grind: chdir failed\n");
     61c:	00001517          	auipc	a0,0x1
     620:	ffc50513          	addi	a0,a0,-4 # 1618 <malloc+0x218>
     624:	00001097          	auipc	ra,0x1
     628:	d1e080e7          	jalr	-738(ra) # 1342 <printf>
        exit(1,"");
     62c:	00001597          	auipc	a1,0x1
     630:	05c58593          	addi	a1,a1,92 # 1688 <malloc+0x288>
     634:	4505                	li	a0,1
     ...
     66e:	01e58593          	addi	a1,a1,30 # 1688 <malloc+0x288>
     672:	4501                	li	a0,0
     674:	00001097          	auipc	ra,0x1
     678:	94e080e7          	jalr	-1714(ra) # fc2 <exit>
        printf("grind: fork failed\n");
     67c:	00001517          	auipc	a0,0x1
     680:	f7450513          	addi	a0,a0,-140 # 15f0 <malloc+0x1f0>
     684:	00001097          	auipc	ra,0x1
     688:	cbe080e7          	jalr	-834(ra) # 1342 <printf>
        exit(1,"");
     68c:	00001597          	auipc	a1,0x1
     690:	ffc58593          	addi	a1,a1,-4 # 1688 <malloc+0x288>
     694:	4505                	li	a0,1
     ...
     6e6:	f4e50513          	addi	a0,a0,-178 # 1630 <malloc+0x230>
     6ea:	00001097          	auipc	ra,0x1
     6ee:	c58080e7          	jalr	-936(ra) # 1342 <printf>
        exit(1,"");
     6f2:	00001597          	auipc	a1,0x1
     6f6:	f9658593          	addi	a1,a1,-106 # 1688 <malloc+0x288>
     6fa:	4505                	li	a0,1
     ...
     71a:	f3258593          	addi	a1,a1,-206 # 1648 <malloc+0x248>
     ...
     74c:	f4058593          	addi	a1,a1,-192 # 1688 <malloc+0x288>
     750:	4501                	li	a0,0
     752:	00001097          	auipc	ra,0x1
     756:	870080e7          	jalr	-1936(ra) # fc2 <exit>
          printf("grind: pipe write failed\n");
     75a:	00001517          	auipc	a0,0x1
     75e:	ef650513          	addi	a0,a0,-266 # 1650 <malloc+0x250>
     762:	00001097          	auipc	ra,0x1
     766:	be0080e7          	jalr	-1056(ra) # 1342 <printf>
     76a:	b7d9                	j	730 <go+0x6b8>
          printf("grind: pipe read failed\n");
     76c:	00001517          	auipc	a0,0x1
     770:	f0450513          	addi	a0,a0,-252 # 1670 <malloc+0x270>
     774:	00001097          	auipc	ra,0x1
     778:	bce080e7          	jalr	-1074(ra) # 1342 <printf>
     77c:	b7f1                	j	748 <go+0x6d0>
        printf("grind: fork failed\n");
     77e:	00001517          	auipc	a0,0x1
     782:	e7250513          	addi	a0,a0,-398 # 15f0 <malloc+0x1f0>
     786:	00001097          	auipc	ra,0x1
     78a:	bbc080e7          	jalr	-1092(ra) # 1342 <printf>
        exit(1,"");
     78e:	00001597          	auipc	a1,0x1
     792:	efa58593          	addi	a1,a1,-262 # 1688 <malloc+0x288>
     796:	4505                	li	a0,1
     ...
     884:	dc858593          	addi	a1,a1,-568 # 1648 <malloc+0x248>
     ...
     8ca:	dca50513          	addi	a0,a0,-566 # 1690 <malloc+0x290>
     8ce:	00000097          	auipc	ra,0x0
     8d2:	744080e7          	jalr	1860(ra) # 1012 <unlink>
     8d6:	b891                	j	12a <go+0xb2>
        printf("grind: create c failed\n");
     8d8:	00001517          	auipc	a0,0x1
     8dc:	dc050513          	addi	a0,a0,-576 # 1698 <malloc+0x298>
     8e0:	00001097          	auipc	ra,0x1
     8e4:	a62080e7          	jalr	-1438(ra) # 1342 <printf>
        exit(1,"");
     8e8:	00001597          	auipc	a1,0x1
     8ec:	da058593          	addi	a1,a1,-608 # 1688 <malloc+0x288>
     8f0:	4505                	li	a0,1
     8f2:	00000097          	auipc	ra,0x0
     8f6:	6d0080e7          	jalr	1744(ra) # fc2 <exit>
        printf("grind: write c failed\n");
     8fa:	00001517          	auipc	a0,0x1
     8fe:	db650513          	addi	a0,a0,-586 # 16b0 <malloc+0x2b0>
     902:	00001097          	auipc	ra,0x1
     906:	a40080e7          	jalr	-1472(ra) # 1342 <printf>
        exit(1,"");
     90a:	00001597          	auipc	a1,0x1
     90e:	d7e58593          	addi	a1,a1,-642 # 1688 <malloc+0x288>
     912:	4505                	li	a0,1
     914:	00000097          	auipc	ra,0x0
     918:	6ae080e7          	jalr	1710(ra) # fc2 <exit>
        printf("grind: fstat failed\n");
     91c:	00001517          	auipc	a0,0x1
     920:	dac50513          	addi	a0,a0,-596 # 16c8 <malloc+0x2c8>
     924:	00001097          	auipc	ra,0x1
     928:	a1e080e7          	jalr	-1506(ra) # 1342 <printf>
        exit(1,"");
     92c:	00001597          	auipc	a1,0x1
     930:	d5c58593          	addi	a1,a1,-676 # 1688 <malloc+0x288>
     934:	4505                	li	a0,1
     ...
     944:	da050513          	addi	a0,a0,-608 # 16e0 <malloc+0x2e0>
     948:	00001097          	auipc	ra,0x1
     94c:	9fa080e7          	jalr	-1542(ra) # 1342 <printf>
        exit(1,"");
     950:	00001597          	auipc	a1,0x1
     954:	d3858593          	addi	a1,a1,-712 # 1688 <malloc+0x288>
     958:	4505                	li	a0,1
     95a:	00000097          	auipc	ra,0x0
     95e:	668080e7          	jalr	1640(ra) # fc2 <exit>
        printf("grind: fstat reports crazy i-number %d\n", st.ino);
     962:	00001517          	auipc	a0,0x1
     966:	da650513          	addi	a0,a0,-602 # 1708 <malloc+0x308>
     96a:	00001097          	auipc	ra,0x1
     96e:	9d8080e7          	jalr	-1576(ra) # 1342 <printf>
        exit(1,"");
     972:	00001597          	auipc	a1,0x1
     976:	d1658593          	addi	a1,a1,-746 # 1688 <malloc+0x288>
     97a:	4505                	li	a0,1
     97c:	00000097          	auipc	ra,0x0
     980:	646080e7          	jalr	1606(ra) # fc2 <exit>
        fprintf(2, "grind: pipe failed\n");
     984:	00001597          	auipc	a1,0x1
     988:	cac58593          	addi	a1,a1,-852 # 1630 <malloc+0x230>
     98c:	4509                	li	a0,2
     98e:	00001097          	auipc	ra,0x1
     992:	986080e7          	jalr	-1658(ra) # 1314 <fprintf>
        exit(1,"");
     996:	00001597          	auipc	a1,0x1
     99a:	cf258593          	addi	a1,a1,-782 # 1688 <malloc+0x288>
     99e:	4505                	li	a0,1
     9a0:	00000097          	auipc	ra,0x0
     9a4:	622080e7          	jalr	1570(ra) # fc2 <exit>
        fprintf(2, "grind: pipe failed\n");
     9a8:	00001597          	auipc	a1,0x1
     9ac:	c8858593          	addi	a1,a1,-888 # 1630 <malloc+0x230>
     9b0:	4509                	li	a0,2
     9b2:	00001097          	auipc	ra,0x1
     9b6:	962080e7          	jalr	-1694(ra) # 1314 <fprintf>
        exit(1,"");
     9ba:	00001597          	auipc	a1,0x1
     9be:	cce58593          	addi	a1,a1,-818 # 1688 <malloc+0x288>
     9c2:	4505                	li	a0,1
     ...
     a10:	d2458593          	addi	a1,a1,-732 # 1730 <malloc+0x330>
     a14:	4509                	li	a0,2
     a16:	00001097          	auipc	ra,0x1
     a1a:	8fe080e7          	jalr	-1794(ra) # 1314 <fprintf>
          exit(1,"");
     a1e:	00001597          	auipc	a1,0x1
     a22:	c6a58593          	addi	a1,a1,-918 # 1688 <malloc+0x288>
     a26:	4505                	li	a0,1
     ...
     a40:	d0c78793          	addi	a5,a5,-756 # 1748 <malloc+0x348>
     a44:	faf43423          	sd	a5,-88(s0)
     a48:	00001797          	auipc	a5,0x1
     a4c:	d0878793          	addi	a5,a5,-760 # 1750 <malloc+0x350>
     a50:	faf43823          	sd	a5,-80(s0)
     a54:	fa043c23          	sd	zero,-72(s0)
        exec("grindir/../echo", args);
     a58:	fa840593          	addi	a1,s0,-88
     a5c:	00001517          	auipc	a0,0x1
     a60:	cfc50513          	addi	a0,a0,-772 # 1758 <malloc+0x358>
     a64:	00000097          	auipc	ra,0x0
     a68:	596080e7          	jalr	1430(ra) # ffa <exec>
        fprintf(2, "grind: echo: not found\n");
     a6c:	00001597          	auipc	a1,0x1
     a70:	cfc58593          	addi	a1,a1,-772 # 1768 <malloc+0x368>
     a74:	4509                	li	a0,2
     a76:	00001097          	auipc	ra,0x1
     a7a:	89e080e7          	jalr	-1890(ra) # 1314 <fprintf>
        exit(2,"");
     a7e:	00001597          	auipc	a1,0x1
     a82:	c0a58593          	addi	a1,a1,-1014 # 1688 <malloc+0x288>
     a86:	4509                	li	a0,2
     a88:	00000097          	auipc	ra,0x0
     a8c:	53a080e7          	jalr	1338(ra) # fc2 <exit>
        fprintf(2, "grind: fork failed\n");
     a90:	00001597          	auipc	a1,0x1
     a94:	b6058593          	addi	a1,a1,-1184 # 15f0 <malloc+0x1f0>
     a98:	4509                	li	a0,2
     a9a:	00001097          	auipc	ra,0x1
     a9e:	87a080e7          	jalr	-1926(ra) # 1314 <fprintf>
        exit(3,"");
     aa2:	00001597          	auipc	a1,0x1
     aa6:	be658593          	addi	a1,a1,-1050 # 1688 <malloc+0x288>
     aaa:	450d                	li	a0,3
     ...
     ae8:	c4c58593          	addi	a1,a1,-948 # 1730 <malloc+0x330>
     aec:	4509                	li	a0,2
     aee:	00001097          	auipc	ra,0x1
     af2:	826080e7          	jalr	-2010(ra) # 1314 <fprintf>
          exit(4,"");
     af6:	00001597          	auipc	a1,0x1
     afa:	b9258593          	addi	a1,a1,-1134 # 1688 <malloc+0x288>
     afe:	4511                	li	a0,4
     ...
     b34:	c0058593          	addi	a1,a1,-1024 # 1730 <malloc+0x330>
     b38:	4509                	li	a0,2
     b3a:	00000097          	auipc	ra,0x0
     b3e:	7da080e7          	jalr	2010(ra) # 1314 <fprintf>
          exit(5,"");
     b42:	00001597          	auipc	a1,0x1
     b46:	b4658593          	addi	a1,a1,-1210 # 1688 <malloc+0x288>
     b4a:	4515                	li	a0,5
     ...
     b64:	c2078793          	addi	a5,a5,-992 # 1780 <malloc+0x380>
     b68:	faf43423          	sd	a5,-88(s0)
     b6c:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     b70:	fa840593          	addi	a1,s0,-88
     b74:	00001517          	auipc	a0,0x1
     b78:	c1450513          	addi	a0,a0,-1004 # 1788 <malloc+0x388>
     b7c:	00000097          	auipc	ra,0x0
     b80:	47e080e7          	jalr	1150(ra) # ffa <exec>
        fprintf(2, "grind: cat: not found\n");
     b84:	00001597          	auipc	a1,0x1
     b88:	c0c58593          	addi	a1,a1,-1012 # 1790 <malloc+0x390>
     b8c:	4509                	li	a0,2
     b8e:	00000097          	auipc	ra,0x0
     b92:	786080e7          	jalr	1926(ra) # 1314 <fprintf>
        exit(6,"");
     b96:	00001597          	auipc	a1,0x1
     b9a:	af258593          	addi	a1,a1,-1294 # 1688 <malloc+0x288>
     b9e:	4519                	li	a0,6
     ba0:	00000097          	auipc	ra,0x0
     ba4:	422080e7          	jalr	1058(ra) # fc2 <exit>
        fprintf(2, "grind: fork failed\n");
     ba8:	00001597          	auipc	a1,0x1
     bac:	a4858593          	addi	a1,a1,-1464 # 15f0 <malloc+0x1f0>
     bb0:	4509                	li	a0,2
     bb2:	00000097          	auipc	ra,0x0
     bb6:	762080e7          	jalr	1890(ra) # 1314 <fprintf>
        exit(7,"");
     bba:	00001597          	auipc	a1,0x1
     bbe:	ace58593          	addi	a1,a1,-1330 # 1688 <malloc+0x288>
     bc2:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     bdc:	9f850513          	addi	a0,a0,-1544 # 15d0 <malloc+0x1d0>
     be0:	00000097          	auipc	ra,0x0
     be4:	432080e7          	jalr	1074(ra) # 1012 <unlink>
  unlink("b");
     be8:	00001517          	auipc	a0,0x1
     bec:	99850513          	addi	a0,a0,-1640 # 1580 <malloc+0x180>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     c26:	9ce50513          	addi	a0,a0,-1586 # 15f0 <malloc+0x1f0>
     c2a:	00000097          	auipc	ra,0x0
     c2e:	718080e7          	jalr	1816(ra) # 1342 <printf>
    exit(1,"");
     c32:	00001597          	auipc	a1,0x1
     c36:	a5658593          	addi	a1,a1,-1450 # 1688 <malloc+0x288>
     c3a:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     c76:	97e50513          	addi	a0,a0,-1666 # 15f0 <malloc+0x1f0>
     c7a:	00000097          	auipc	ra,0x0
     c7e:	6c8080e7          	jalr	1736(ra) # 1342 <printf>
    exit(1,"");
     c82:	00001597          	auipc	a1,0x1
     c86:	a0658593          	addi	a1,a1,-1530 # 1688 <malloc+0x288>
     c8a:	4505                	li	a0,1
  ...
  exit(0,"");
     ...
     cc6:	9c658593          	addi	a1,a1,-1594 # 1688 <malloc+0x288>
     cca:	4501                	li	a0,0
...
_main()
{
  ...
  exit(0,"");
     ...
     d46:	94658593          	addi	a1,a1,-1722 # 1688 <malloc+0x288>
     d4a:	4501                	li	a0,0
...
putc(int fd, char c)
{
    ...
    1072:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    1076:	4605                	li	a2,1
    1078:	fef40593          	addi	a1,s0,-17
    107c:	00000097          	auipc	ra,0x0
    1080:	f66080e7          	jalr	-154(ra) # fe2 <write>
}
...
000000000000108c <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    108c:	7139                	addi	sp,sp,-64
    108e:	fc06                	sd	ra,56(sp)
    1090:	f822                	sd	s0,48(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
    109c:	c299                	beqz	a3,10a2 <printint+0x16>
    109e:	0805c863          	bltz	a1,112e <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    10a2:	2581                	sext.w	a1,a1
  neg = 0;
    10a4:	4881                	li	a7,0
    10a6:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    10ac:	2601                	sext.w	a2,a2
    10ae:	00000517          	auipc	a0,0x0
    10b2:	73250513          	addi	a0,a0,1842 # 17e0 <digits>
    10b6:	883a                	mv	a6,a4
    10b8:	2705                	addiw	a4,a4,1
    10ba:	02c5f7bb          	remuw	a5,a1,a2
    10be:	1782                	slli	a5,a5,0x20
    10c0:	9381                	srli	a5,a5,0x20
    10c2:	97aa                	add	a5,a5,a0
    10c4:	0007c783          	lbu	a5,0(a5)
    10c8:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    10cc:	0005879b          	sext.w	a5,a1
    10d0:	02c5d5bb          	divuw	a1,a1,a2
    10d4:	0685                	addi	a3,a3,1
    10d6:	fec7f0e3          	bgeu	a5,a2,10b6 <printint+0x2a>
  if(neg)
    10da:	00088b63          	beqz	a7,10f0 <printint+0x64>
    buf[i++] = '-';
    10de:	fd040793          	addi	a5,s0,-48
    10e2:	973e                	add	a4,a4,a5
    10e4:	02d00793          	li	a5,45
    10e8:	fef70823          	sb	a5,-16(a4)
    10ec:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    10f0:	02e05863          	blez	a4,1120 <printint+0x94>
    10f4:	fc040793          	addi	a5,s0,-64
    10f8:	00e78933          	add	s2,a5,a4
    10fc:	fff78993          	addi	s3,a5,-1
    1100:	99ba                	add	s3,s3,a4
    1102:	377d                	addiw	a4,a4,-1
    1104:	1702                	slli	a4,a4,0x20
    1106:	9301                	srli	a4,a4,0x20
    1108:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    110c:	fff94583          	lbu	a1,-1(s2)
    1110:	8526                	mv	a0,s1
    1112:	00000097          	auipc	ra,0x0
    1116:	f58080e7          	jalr	-168(ra) # 106a <putc>
  while(--i >= 0)
    111a:	197d                	addi	s2,s2,-1
    111c:	ff3918e3          	bne	s2,s3,110c <printint+0x80>
}
    1120:	70e2                	ld	ra,56(sp)
    1122:	7442                	ld	s0,48(sp)
    ...
    112c:	8082                	ret
    x = -xx;
    112e:	40b005bb          	negw	a1,a1
    neg = 1;
    1132:	4885                	li	a7,1
    x = -xx;
    1134:	bf8d                	j	10a6 <printint+0x1a>

0000000000001136 <vprintf>:
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
    ...
    1142:	e8d2                	sd	s4,80(sp)
    1144:	e4d6                	sd	s5,72(sp)
    1146:	e0da                	sd	s6,64(sp)
    1148:	fc5e                	sd	s7,56(sp)
    114a:	f862                	sd	s8,48(sp)
    114c:	f466                	sd	s9,40(sp)
    114e:	f06a                	sd	s10,32(sp)
    1150:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    1154:	0005c903          	lbu	s2,0(a1)
    1158:	18090f63          	beqz	s2,12f6 <vprintf+0x1c0>
    115c:	8aaa                	mv	s5,a0
    115e:	8b32                	mv	s6,a2
    1160:	00158493          	addi	s1,a1,1
  state = 0;
    1164:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    1166:	02500a13          	li	s4,37
      if(c == 'd'){
    116a:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    116e:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    1172:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    1176:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    117a:	00000b97          	auipc	s7,0x0
    117e:	666b8b93          	addi	s7,s7,1638 # 17e0 <digits>
    1182:	a839                	j	11a0 <vprintf+0x6a>
        putc(fd, c);
    1184:	85ca                	mv	a1,s2
    1186:	8556                	mv	a0,s5
    1188:	00000097          	auipc	ra,0x0
    118c:	ee2080e7          	jalr	-286(ra) # 106a <putc>
    1190:	a019                	j	1196 <vprintf+0x60>
    } else if(state == '%'){
    1192:	01498f63          	beq	s3,s4,11b0 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    1196:	0485                	addi	s1,s1,1
    1198:	fff4c903          	lbu	s2,-1(s1)
    119c:	14090d63          	beqz	s2,12f6 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    11a0:	0009079b          	sext.w	a5,s2
    if(state == 0){
    11a4:	fe0997e3          	bnez	s3,1192 <vprintf+0x5c>
      if(c == '%'){
    11a8:	fd479ee3          	bne	a5,s4,1184 <vprintf+0x4e>
        state = '%';
    11ac:	89be                	mv	s3,a5
    11ae:	b7e5                	j	1196 <vprintf+0x60>
      if(c == 'd'){
    11b0:	05878063          	beq	a5,s8,11f0 <vprintf+0xba>
      } else if(c == 'l') {
    11b4:	05978c63          	beq	a5,s9,120c <vprintf+0xd6>
      } else if(c == 'x') {
    11b8:	07a78863          	beq	a5,s10,1228 <vprintf+0xf2>
      } else if(c == 'p') {
    11bc:	09b78463          	beq	a5,s11,1244 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    11c0:	07300713          	li	a4,115
    11c4:	0ce78663          	beq	a5,a4,1290 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    11c8:	06300713          	li	a4,99
    11cc:	0ee78e63          	beq	a5,a4,12c8 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    11d0:	11478863          	beq	a5,s4,12e0 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    11dc:	e92080e7          	jalr	-366(ra) # 106a <putc>
        putc(fd, c);
    11e0:	85ca                	mv	a1,s2
    11e2:	8556                	mv	a0,s5
    11e4:	00000097          	auipc	ra,0x0
    11e8:	e86080e7          	jalr	-378(ra) # 106a <putc>
      }
      state = 0;
    11ec:	4981                	li	s3,0
    11ee:	b765                	j	1196 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    11f0:	008b0913          	addi	s2,s6,8
    11f4:	4685                	li	a3,1
    11f6:	4629                	li	a2,10
    11f8:	000b2583          	lw	a1,0(s6)
    11fc:	8556                	mv	a0,s5
    11fe:	00000097          	auipc	ra,0x0
    1202:	e8e080e7          	jalr	-370(ra) # 108c <printint>
    1206:	8b4a                	mv	s6,s2
      state = 0;
    1208:	4981                	li	s3,0
    120a:	b771                	j	1196 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    120c:	008b0913          	addi	s2,s6,8
    1210:	4681                	li	a3,0
    1212:	4629                	li	a2,10
    1214:	000b2583          	lw	a1,0(s6)
    1218:	8556                	mv	a0,s5
    121a:	00000097          	auipc	ra,0x0
    121e:	e72080e7          	jalr	-398(ra) # 108c <printint>
    1222:	8b4a                	mv	s6,s2
      state = 0;
    1224:	4981                	li	s3,0
    1226:	bf85                	j	1196 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    1228:	008b0913          	addi	s2,s6,8
    122c:	4681                	li	a3,0
    122e:	4641                	li	a2,16
    1230:	000b2583          	lw	a1,0(s6)
    1234:	8556                	mv	a0,s5
    1236:	00000097          	auipc	ra,0x0
    123a:	e56080e7          	jalr	-426(ra) # 108c <printint>
    123e:	8b4a                	mv	s6,s2
      state = 0;
    1240:	4981                	li	s3,0
    1242:	bf91                	j	1196 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    1244:	008b0793          	addi	a5,s6,8
    1248:	f8f43423          	sd	a5,-120(s0)
    124c:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    1250:	03000593          	li	a1,48
    1254:	8556                	mv	a0,s5
    1256:	00000097          	auipc	ra,0x0
    125a:	e14080e7          	jalr	-492(ra) # 106a <putc>
  putc(fd, 'x');
    125e:	85ea                	mv	a1,s10
    1260:	8556                	mv	a0,s5
    ...
    1270:	97de                	add	a5,a5,s7
    1272:	0007c583          	lbu	a1,0(a5)
    1276:	8556                	mv	a0,s5
    1278:	00000097          	auipc	ra,0x0
    127c:	df2080e7          	jalr	-526(ra) # 106a <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1280:	0992                	slli	s3,s3,0x4
    1282:	397d                	addiw	s2,s2,-1
    1284:	fe0914e3          	bnez	s2,126c <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    1288:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    128c:	4981                	li	s3,0
    128e:	b721                	j	1196 <vprintf+0x60>
        s = va_arg(ap, char*);
    1290:	008b0993          	addi	s3,s6,8
    1294:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    1298:	02090163          	beqz	s2,12ba <vprintf+0x184>
        while(*s != 0){
    129c:	00094583          	lbu	a1,0(s2)
    12a0:	c9a1                	beqz	a1,12f0 <vprintf+0x1ba>
          putc(fd, *s);
    12a2:	8556                	mv	a0,s5
    12a4:	00000097          	auipc	ra,0x0
    12a8:	dc6080e7          	jalr	-570(ra) # 106a <putc>
          s++;
    12ac:	0905                	addi	s2,s2,1
        while(*s != 0){
    12ae:	00094583          	lbu	a1,0(s2)
    12b2:	f9e5                	bnez	a1,12a2 <vprintf+0x16c>
        s = va_arg(ap, char*);
    12b4:	8b4e                	mv	s6,s3
      state = 0;
    12b6:	4981                	li	s3,0
    12b8:	bdf9                	j	1196 <vprintf+0x60>
          s = "(null)";
    12ba:	00000917          	auipc	s2,0x0
    12be:	51e90913          	addi	s2,s2,1310 # 17d8 <malloc+0x3d8>
        while(*s != 0){
    12c2:	02800593          	li	a1,40
    12c6:	bff1                	j	12a2 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    12c8:	008b0913          	addi	s2,s6,8
    12cc:	000b4583          	lbu	a1,0(s6)
    12d0:	8556                	mv	a0,s5
    12d2:	00000097          	auipc	ra,0x0
    12d6:	d98080e7          	jalr	-616(ra) # 106a <putc>
    12da:	8b4a                	mv	s6,s2
      state = 0;
    12dc:	4981                	li	s3,0
    12de:	bd65                	j	1196 <vprintf+0x60>
        putc(fd, c);
    12e0:	85d2                	mv	a1,s4
    12e2:	8556                	mv	a0,s5
    12e4:	00000097          	auipc	ra,0x0
    12e8:	d86080e7          	jalr	-634(ra) # 106a <putc>
      state = 0;
    12ec:	4981                	li	s3,0
    12ee:	b565                	j	1196 <vprintf+0x60>
        s = va_arg(ap, char*);
    12f0:	8b4e                	mv	s6,s3
      state = 0;
    12f2:	4981                	li	s3,0
    12f4:	b54d                	j	1196 <vprintf+0x60>
    }
  }
}
    12f6:	70e6                	ld	ra,120(sp)
    12f8:	7446                	ld	s0,112(sp)
    12fa:	74a6                	ld	s1,104(sp)
    12fc:	7906                	ld	s2,96(sp)
    12fe:	69e6                	ld	s3,88(sp)
    1300:	6a46                	ld	s4,80(sp)
    1302:	6aa6                	ld	s5,72(sp)
    1304:	6b06                	ld	s6,64(sp)
    1306:	7be2                	ld	s7,56(sp)
    1308:	7c42                	ld	s8,48(sp)
    130a:	7ca2                	ld	s9,40(sp)
    130c:	7d02                	ld	s10,32(sp)
    130e:	6de2                	ld	s11,24(sp)
    1310:	6109                	addi	sp,sp,128
    1312:	8082                	ret

0000000000001314 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    1314:	715d                	addi	sp,sp,-80
    1316:	ec06                	sd	ra,24(sp)
    1318:	e822                	sd	s0,16(sp)
    131a:	1000                	addi	s0,sp,32
    131c:	e010                	sd	a2,0(s0)
    131e:	e414                	sd	a3,8(s0)
    1320:	e818                	sd	a4,16(s0)
    1322:	ec1c                	sd	a5,24(s0)
    1324:	03043023          	sd	a6,32(s0)
    1328:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    132c:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    1330:	8622                	mv	a2,s0
    1332:	00000097          	auipc	ra,0x0
    1336:	e04080e7          	jalr	-508(ra) # 1136 <vprintf>
}
...
printf(const char *fmt, ...)
{
    ...
    134a:	e40c                	sd	a1,8(s0)
    134c:	e810                	sd	a2,16(s0)
    134e:	ec14                	sd	a3,24(s0)
    1350:	f018                	sd	a4,32(s0)
    1352:	f41c                	sd	a5,40(s0)
    1354:	03043823          	sd	a6,48(s0)
    1358:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    135c:	00840613          	addi	a2,s0,8
    1360:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    1364:	85aa                	mv	a1,a0
    1366:	4505                	li	a0,1
    1368:	00000097          	auipc	ra,0x0
    136c:	dce080e7          	jalr	-562(ra) # 1136 <vprintf>
}
    1370:	60e2                	ld	ra,24(sp)
    1372:	6442                	ld	s0,16(sp)
    1374:	6125                	addi	sp,sp,96
    1376:	8082                	ret

0000000000001378 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    1378:	1141                	addi	sp,sp,-16
    137a:	e422                	sd	s0,8(sp)
    137c:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    137e:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1382:	00001797          	auipc	a5,0x1
    1386:	c8e7b783          	ld	a5,-882(a5) # 2010 <freep>
    138a:	a805                	j	13ba <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    138c:	4618                	lw	a4,8(a2)
    138e:	9db9                	addw	a1,a1,a4
    1390:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1394:	6398                	ld	a4,0(a5)
    1396:	6318                	ld	a4,0(a4)
    1398:	fee53823          	sd	a4,-16(a0)
    139c:	a091                	j	13e0 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    139e:	ff852703          	lw	a4,-8(a0)
    13a2:	9e39                	addw	a2,a2,a4
    13a4:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    13a6:	ff053703          	ld	a4,-16(a0)
    13aa:	e398                	sd	a4,0(a5)
    13ac:	a099                	j	13f2 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    13ae:	6398                	ld	a4,0(a5)
    13b0:	00e7e463          	bltu	a5,a4,13b8 <free+0x40>
    13b4:	00e6ea63          	bltu	a3,a4,13c8 <free+0x50>
{
    13b8:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    13ba:	fed7fae3          	bgeu	a5,a3,13ae <free+0x36>
    13be:	6398                	ld	a4,0(a5)
    13c0:	00e6e463          	bltu	a3,a4,13c8 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    13c4:	fee7eae3          	bltu	a5,a4,13b8 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    13c8:	ff852583          	lw	a1,-8(a0)
    13cc:	6390                	ld	a2,0(a5)
    13ce:	02059713          	slli	a4,a1,0x20
    13d2:	9301                	srli	a4,a4,0x20
    13d4:	0712                	slli	a4,a4,0x4
    13d6:	9736                	add	a4,a4,a3
    13d8:	fae60ae3          	beq	a2,a4,138c <free+0x14>
    bp->s.ptr = p->s.ptr;
    13dc:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    13e0:	4790                	lw	a2,8(a5)
    13e2:	02061713          	slli	a4,a2,0x20
    13e6:	9301                	srli	a4,a4,0x20
    13e8:	0712                	slli	a4,a4,0x4
    13ea:	973e                	add	a4,a4,a5
    13ec:	fae689e3          	beq	a3,a4,139e <free+0x26>
  } else
    p->s.ptr = bp;
    13f0:	e394                	sd	a3,0(a5)
  freep = p;
    13f2:	00001717          	auipc	a4,0x1
    13f6:	c0f73f23          	sd	a5,-994(a4) # 2010 <freep>
}
    13fa:	6422                	ld	s0,8(sp)
    13fc:	0141                	addi	sp,sp,16
    13fe:	8082                	ret

0000000000001400 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1414:	02051493          	slli	s1,a0,0x20
    1418:	9081                	srli	s1,s1,0x20
    141a:	04bd                	addi	s1,s1,15
    141c:	8091                	srli	s1,s1,0x4
    141e:	0014899b          	addiw	s3,s1,1
    1422:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    1424:	00001517          	auipc	a0,0x1
    1428:	bec53503          	ld	a0,-1044(a0) # 2010 <freep>
    142c:	c515                	beqz	a0,1458 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    142e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1430:	4798                	lw	a4,8(a5)
    1432:	02977f63          	bgeu	a4,s1,1470 <malloc+0x70>
    1436:	8a4e                	mv	s4,s3
    1438:	0009871b          	sext.w	a4,s3
    143c:	6685                	lui	a3,0x1
    143e:	00d77363          	bgeu	a4,a3,1444 <malloc+0x44>
    1442:	6a05                	lui	s4,0x1
    1444:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    1448:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    144c:	00001917          	auipc	s2,0x1
    1450:	bc490913          	addi	s2,s2,-1084 # 2010 <freep>
  if(p == (char*)-1)
    1454:	5afd                	li	s5,-1
    1456:	a88d                	j	14c8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1458:	00001797          	auipc	a5,0x1
    145c:	fb078793          	addi	a5,a5,-80 # 2408 <base>
    1460:	00001717          	auipc	a4,0x1
    1464:	baf73823          	sd	a5,-1104(a4) # 2010 <freep>
    1468:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    146a:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    146e:	b7e1                	j	1436 <malloc+0x36>
      if(p->s.size == nunits)
    1470:	02e48b63          	beq	s1,a4,14a6 <malloc+0xa6>
        p->s.size -= nunits;
    1474:	4137073b          	subw	a4,a4,s3
    1478:	c798                	sw	a4,8(a5)
        p += p->s.size;
    147a:	1702                	slli	a4,a4,0x20
    147c:	9301                	srli	a4,a4,0x20
    147e:	0712                	slli	a4,a4,0x4
    1480:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    1482:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1486:	00001717          	auipc	a4,0x1
    148a:	b8a73523          	sd	a0,-1142(a4) # 2010 <freep>
      return (void*)(p + 1);
    148e:	01078513          	addi	a0,a5,16
    ...
    14a0:	6b02                	ld	s6,0(sp)
    14a2:	6121                	addi	sp,sp,64
    14a4:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    14a6:	6398                	ld	a4,0(a5)
    14a8:	e118                	sd	a4,0(a0)
    14aa:	bff1                	j	1486 <malloc+0x86>
  hp->s.size = nu;
    14ac:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    14b0:	0541                	addi	a0,a0,16
    14b2:	00000097          	auipc	ra,0x0
    14b6:	ec6080e7          	jalr	-314(ra) # 1378 <free>
  return freep;
    14ba:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    14be:	d971                	beqz	a0,1492 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    14c0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    14c2:	4798                	lw	a4,8(a5)
    14c4:	fa9776e3          	bgeu	a4,s1,1470 <malloc+0x70>
    if(p == freep)
    14c8:	00093703          	ld	a4,0(s2)
    14cc:	853e                	mv	a0,a5
    14ce:	fef719e3          	bne	a4,a5,14c0 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    14d2:	8552                	mv	a0,s4
    14d4:	00000097          	auipc	ra,0x0
    14d8:	b76080e7          	jalr	-1162(ra) # 104a <sbrk>
  if(p == (char*)-1)
    14dc:	fd5518e3          	bne	a0,s5,14ac <malloc+0xac>
        return 0;
    14e0:	4501                	li	a0,0
    14e2:	bf45                	j	1492 <malloc+0x92>

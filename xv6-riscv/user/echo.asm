...
main(int argc, char *argv[])
{
  ...
  7e:	7d658593          	addi	a1,a1,2006 # 850 <malloc+0xf6>
  82:	4501                	li	a0,0
...
_main()
{
  ...
  a0:	7b458593          	addi	a1,a1,1972 # 850 <malloc+0xf6>
  a4:	4501                	li	a0,0
...
putc(int fd, char c)
{
 ...
 3da:	f66080e7          	jalr	-154(ra) # 33c <write>
}
...
malloc(uint nbytes)
{
 ...
 832:	b76080e7          	jalr	-1162(ra) # 3a4 <sbrk>
  if(p == (char*)-1)

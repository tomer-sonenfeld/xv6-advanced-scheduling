...
main(int argc, char *argv[])
{
  ...
  54:	84058593          	addi	a1,a1,-1984 # 890 <malloc+0x122>
  58:	4505                	li	a0,1
  ...
  68:	81458593          	addi	a1,a1,-2028 # 878 <malloc+0x10a>
  6c:	4509                	li	a0,2
  ...
  7a:	81a58593          	addi	a1,a1,-2022 # 890 <malloc+0x122>
  7e:	4501                	li	a0,0
...
_main()
{
  ...
  9c:	7f858593          	addi	a1,a1,2040 # 890 <malloc+0x122>
  a0:	4501                	li	a0,0

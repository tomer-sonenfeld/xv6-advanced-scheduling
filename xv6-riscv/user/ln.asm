...
main(int argc, char *argv[])
{
  ...
  14:	84058593          	addi	a1,a1,-1984 # 850 <malloc+0xf2>
  18:	4509                	li	a0,2
  1a:	00000097          	auipc	ra,0x0
  1e:	658080e7          	jalr	1624(ra) # 672 <fprintf>
    exit(1,"");
  22:	00001597          	auipc	a1,0x1
  26:	84658593          	addi	a1,a1,-1978 # 868 <malloc+0x10a>
  2a:	4505                	li	a0,1
  2c:	00000097          	auipc	ra,0x0
  30:	2d4080e7          	jalr	724(ra) # 300 <exit>
  34:	84ae                	mv	s1,a1
  }
  ...
  3e:	326080e7          	jalr	806(ra) # 360 <link>
  42:	00054b63          	bltz	a0,58 <main+0x58>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit(0,"");
  46:	00001597          	auipc	a1,0x1
  4a:	82258593          	addi	a1,a1,-2014 # 868 <malloc+0x10a>
  4e:	4501                	li	a0,0
  50:	00000097          	auipc	ra,0x0
  54:	2b0080e7          	jalr	688(ra) # 300 <exit>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  58:	6894                	ld	a3,16(s1)
  5a:	6490                	ld	a2,8(s1)
  5c:	00001597          	auipc	a1,0x1
  60:	81458593          	addi	a1,a1,-2028 # 870 <malloc+0x112>
  64:	4509                	li	a0,2
...
_main()
{
  ...
  84:	7e858593          	addi	a1,a1,2024 # 868 <malloc+0x10a>
  88:	4501                	li	a0,0
...
00000000000003b0 <set_cfs_priority>:
...
00000000000003b8 <get_cfs_stats>:

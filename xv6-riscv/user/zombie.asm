...
main(void)
{
  ...
  18:	7dc58593          	addi	a1,a1,2012 # 7f0 <malloc+0xe8>
  1c:	4501                	li	a0,0
...
_main()
{
  ...
  46:	7ae58593          	addi	a1,a1,1966 # 7f0 <malloc+0xe8>
  4a:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ba:	44a50513          	addi	a0,a0,1098 # 800 <digits>
 3be:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 486:	37eb8b93          	addi	s7,s7,894 # 800 <digits>
 ...
 5c6:	23690913          	addi	s2,s2,566 # 7f8 <malloc+0xf0>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7e0:	b6e080e7          	jalr	-1170(ra) # 34a <sbrk>
  if(p == (char*)-1)

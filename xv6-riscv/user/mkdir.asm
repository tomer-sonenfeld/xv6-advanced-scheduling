...
main(int argc, char *argv[])
{
  ...
  54:	80858593          	addi	a1,a1,-2040 # 858 <malloc+0x102>
  58:	4505                	li	a0,1
  ...
  68:	7fc58593          	addi	a1,a1,2044 # 860 <malloc+0x10a>
  6c:	4509                	li	a0,2
  ...
  7a:	7e258593          	addi	a1,a1,2018 # 858 <malloc+0x102>
  7e:	4501                	li	a0,0
...
_main()
{
  ...
  9c:	7c058593          	addi	a1,a1,1984 # 858 <malloc+0x102>
  a0:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 408:	48450513          	addi	a0,a0,1156 # 888 <digits>
 40c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d4:	3b8b8b93          	addi	s7,s7,952 # 888 <digits>
 ...
 614:	27090913          	addi	s2,s2,624 # 880 <malloc+0x12a>
        while(*s != 0){

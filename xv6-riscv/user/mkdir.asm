...
main(int argc, char *argv[])
{
  ...
  54:	81858593          	addi	a1,a1,-2024 # 868 <malloc+0x10a>
  58:	4505                	li	a0,1
  ...
  68:	80c58593          	addi	a1,a1,-2036 # 870 <malloc+0x112>
  6c:	4509                	li	a0,2
  6e:	00000097          	auipc	ra,0x0
  72:	604080e7          	jalr	1540(ra) # 672 <fprintf>
      break;
    }
  }
  ...
  7a:	7f258593          	addi	a1,a1,2034 # 868 <malloc+0x10a>
  7e:	4501                	li	a0,0
...
_main()
{
  ...
  9c:	7d058593          	addi	a1,a1,2000 # 868 <malloc+0x10a>
  a0:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 410:	48c50513          	addi	a0,a0,1164 # 898 <digits>
 414:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4dc:	3c0b8b93          	addi	s7,s7,960 # 898 <digits>
 ...
 61c:	27890913          	addi	s2,s2,632 # 890 <malloc+0x132>
        while(*s != 0){

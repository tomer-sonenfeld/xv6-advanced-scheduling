...
main(int argc, char *argv[])
{
  ...
  54:	82858593          	addi	a1,a1,-2008 # 878 <malloc+0x10a>
  58:	4505                	li	a0,1
  ...
  68:	81c58593          	addi	a1,a1,-2020 # 880 <malloc+0x112>
  6c:	4509                	li	a0,2
  6e:	00000097          	auipc	ra,0x0
  72:	614080e7          	jalr	1556(ra) # 682 <fprintf>
      break;
    }
  }
  ...
  7a:	80258593          	addi	a1,a1,-2046 # 878 <malloc+0x10a>
  7e:	4501                	li	a0,0
...
_main()
{
  ...
  9c:	7e058593          	addi	a1,a1,2016 # 878 <malloc+0x10a>
  a0:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 420:	48c50513          	addi	a0,a0,1164 # 8a8 <digits>
 424:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ec:	3c0b8b93          	addi	s7,s7,960 # 8a8 <digits>
 ...
 62c:	27890913          	addi	s2,s2,632 # 8a0 <malloc+0x132>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 846:	b5e080e7          	jalr	-1186(ra) # 3a0 <sbrk>
  if(p == (char*)-1)

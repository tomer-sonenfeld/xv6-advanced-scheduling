...
main(int argc, char *argv[])
{
  ...
  54:	82858593          	addi	a1,a1,-2008 # 878 <malloc+0x102>
  58:	4505                	li	a0,1
  ...
  68:	81c58593          	addi	a1,a1,-2020 # 880 <malloc+0x10a>
  6c:	4509                	li	a0,2
  ...
  7a:	80258593          	addi	a1,a1,-2046 # 878 <malloc+0x102>
  7e:	4501                	li	a0,0
...
_main()
{
  ...
  9c:	7e058593          	addi	a1,a1,2016 # 878 <malloc+0x102>
  a0:	4501                	li	a0,0

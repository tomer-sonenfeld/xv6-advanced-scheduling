...
main(int argc, char **argv)
{
  ...
  42:	80a58593          	addi	a1,a1,-2038 # 848 <malloc+0x106>
  46:	4501                	li	a0,0
  48:	00000097          	auipc	ra,0x0
  4c:	2bc080e7          	jalr	700(ra) # 304 <exit>
    fprintf(2, "usage: kill pid...\n");
  50:	00000597          	auipc	a1,0x0
  54:	7e058593          	addi	a1,a1,2016 # 830 <malloc+0xee>
  58:	4509                	li	a0,2
  5a:	00000097          	auipc	ra,0x0
  5e:	5fc080e7          	jalr	1532(ra) # 656 <fprintf>
    exit(1,"");
  62:	00000597          	auipc	a1,0x0
  66:	7e658593          	addi	a1,a1,2022 # 848 <malloc+0x106>
  6a:	4505                	li	a0,1
...
_main()
{
  ...
  88:	7c458593          	addi	a1,a1,1988 # 848 <malloc+0x106>
  8c:	4501                	li	a0,0

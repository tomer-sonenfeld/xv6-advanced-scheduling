...
main(int argc, char *argv[])
{
  ...
  1a:	8f278793          	addi	a5,a5,-1806 # 908 <malloc+0x124>
  1e:	6398                	ld	a4,0(a5)
  ...
  38:	6f2080e7          	jalr	1778(ra) # 726 <printf>
...
//    printf(fd, "%d\n", i);
  ...
  c2:	668080e7          	jalr	1640(ra) # 726 <printf>
 ...
 108:	7fc58593          	addi	a1,a1,2044 # 900 <malloc+0x11c>
 10c:	4501                	li	a0,0
...
_main()
{
 ...
 12a:	7da58593          	addi	a1,a1,2010 # 900 <malloc+0x11c>
 12e:	4501                	li	a0,0

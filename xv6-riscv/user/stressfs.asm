...
main(int argc, char *argv[])
{
  ...
  1a:	8f278793          	addi	a5,a5,-1806 # 908 <malloc+0x11c>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8a450513          	addi	a0,a0,-1884 # 8d0 <malloc+0xe4>
  ...
  6c:	88050513          	addi	a0,a0,-1920 # 8e8 <malloc+0xfc>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	84250513          	addi	a0,a0,-1982 # 8f8 <malloc+0x10c>
 ...
 108:	7fc58593          	addi	a1,a1,2044 # 900 <malloc+0x114>
 10c:	4501                	li	a0,0
...
_main()
{
 ...
 12a:	7da58593          	addi	a1,a1,2010 # 900 <malloc+0x114>
 12e:	4501                	li	a0,0

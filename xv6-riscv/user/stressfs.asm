...
main(int argc, char *argv[])
{
  ...
  1a:	91278793          	addi	a5,a5,-1774 # 928 <malloc+0x124>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8c450513          	addi	a0,a0,-1852 # 8f0 <malloc+0xec>
  34:	00000097          	auipc	ra,0x0
  38:	712080e7          	jalr	1810(ra) # 746 <printf>
  ...
  6c:	8a050513          	addi	a0,a0,-1888 # 908 <malloc+0x104>
  70:	00000097          	auipc	ra,0x0
  74:	6d6080e7          	jalr	1750(ra) # 746 <printf>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	86250513          	addi	a0,a0,-1950 # 918 <malloc+0x114>
  be:	00000097          	auipc	ra,0x0
  c2:	688080e7          	jalr	1672(ra) # 746 <printf>
 ...
 100:	2b2080e7          	jalr	690(ra) # 3ae <wait>

  exit(0,"");
 104:	00001597          	auipc	a1,0x1
 108:	81c58593          	addi	a1,a1,-2020 # 920 <malloc+0x11c>
 10c:	4501                	li	a0,0
...
_main()
{
 ...
 12a:	7fa58593          	addi	a1,a1,2042 # 920 <malloc+0x11c>
 12e:	4501                	li	a0,0
...
000000000000044e <set_ps_priority>:
...
0000000000000456 <set_cfs_priority>:
...
000000000000045e <get_cfs_stats>:

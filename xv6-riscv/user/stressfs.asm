...
main(int argc, char *argv[])
{
  ...
  1a:	90278793          	addi	a5,a5,-1790 # 918 <malloc+0x11c>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8b450513          	addi	a0,a0,-1868 # 8e0 <malloc+0xe4>
  ...
  6c:	89050513          	addi	a0,a0,-1904 # 8f8 <malloc+0xfc>
...
//    printf(fd, "%d\n", i);
 ...
 108:	80c58593          	addi	a1,a1,-2036 # 910 <malloc+0x114>
 10c:	4501                	li	a0,0
...
_main()
{
 ...
 12a:	7ea58593          	addi	a1,a1,2026 # 910 <malloc+0x114>
 12e:	4501                	li	a0,0

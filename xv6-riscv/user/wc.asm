...
wc(int fd, char *name)
{
  ...
  ba:	8da50513          	addi	a0,a0,-1830 # 990 <malloc+0x10c>
  ...
  f8:	89458593          	addi	a1,a1,-1900 # 988 <malloc+0x104>
  fc:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
 ...
 160:	82c58593          	addi	a1,a1,-2004 # 988 <malloc+0x104>
 164:	4501                	li	a0,0
 166:	00000097          	auipc	ra,0x0
 16a:	2e0080e7          	jalr	736(ra) # 446 <exit>
    wc(0, "");
 16e:	00001597          	auipc	a1,0x1
 172:	81a58593          	addi	a1,a1,-2022 # 988 <malloc+0x104>
 176:	4501                	li	a0,0
 178:	00000097          	auipc	ra,0x0
 17c:	e88080e7          	jalr	-376(ra) # 0 <wc>
    exit(0,"");
 180:	00001597          	auipc	a1,0x1
 184:	80858593          	addi	a1,a1,-2040 # 988 <malloc+0x104>
 188:	4501                	li	a0,0
 ...
 198:	80c50513          	addi	a0,a0,-2036 # 9a0 <malloc+0x11c>
 19c:	00000097          	auipc	ra,0x0
 1a0:	62a080e7          	jalr	1578(ra) # 7c6 <printf>
      exit(1,"");
 1a4:	00000597          	auipc	a1,0x0
 1a8:	7e458593          	addi	a1,a1,2020 # 988 <malloc+0x104>
 1ac:	4505                	li	a0,1
...
_main()
{
 ...
 1ca:	7c258593          	addi	a1,a1,1986 # 988 <malloc+0x104>
 1ce:	4501                	li	a0,0
...
malloc(uint nbytes)
{
 ...
 95c:	b76080e7          	jalr	-1162(ra) # 4ce <sbrk>
  if(p == (char*)-1)
